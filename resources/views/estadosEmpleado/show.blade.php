        ...
        <div class="panel-body">
          <div class="row">
        	...
        	<div class="panel-footer">
				<a href="{asset('estadosEmpleado')}{'/'.$estado->id.'/editar'}" data-original-title="editCargo" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
